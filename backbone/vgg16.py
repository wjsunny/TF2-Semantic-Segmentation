...
class VGG_16(Model):
    def __init__(self, include_top, classes):
        ...
        self.maxpool_1 = layers.MaxPooling2D((2, 2), strides = (2, 2), name = 'block1_pool')
        self.maxpool_2 = layers.MaxPooling2D((2, 2), strides = (2, 2), name = 'block2_pool')
        self.maxpool_3 = layers.MaxPooling2D((2, 2), strides = (2, 2), name = 'block3_pool')
        self.maxpool_4 = layers.MaxPooling2D((2, 2), strides = (2, 2), name = 'block4_pool')
        self.maxpool_5 = layers.MaxPooling2D((2, 2), strides = (2, 2), name = 'block5_pool')
...
def vgg16(include_top = True, pretrained = 'imagenet', classes = 1000):
    ...
    if pretrained == 'imagenet':
        if include_top:
            ...
            print(weights_path)
            model.load_weights(weights_path, True, True)
