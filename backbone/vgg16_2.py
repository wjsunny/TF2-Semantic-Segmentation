...
def vgg16(input_shape=(224, 224, 3), include_top = True, classes = 1000, pretrained = 'imagenet'):
    ...
    x = layers.MaxPooling2D((2,2), strides = (2, 2), name = 'block1_pool', data_format = IMAGE_FORMAT)(x)
    ...
    x = layers.MaxPooling2D((2,2), strides = (2, 2), name = 'block2_pool', data_format = IMAGE_FORMAT)(x)
    ...
    x = layers.MaxPooling2D((2,2), strides = (2, 2), name = 'block3_pool', data_format = IMAGE_FORMAT)(x)
    ...
    x = layers.MaxPooling2D((2,2), strides = (2, 2), name = 'block4_pool', data_format = IMAGE_FORMAT)(x)
    ...
    x = layers.MaxPooling2D((2,2), strides = (2, 2), name = 'block5_pool', data_format = IMAGE_FORMAT)(x)
